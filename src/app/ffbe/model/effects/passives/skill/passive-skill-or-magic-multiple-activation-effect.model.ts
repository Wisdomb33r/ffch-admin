...
export class PassiveSkillOrMagicMultipleActivationEffectModel extends SkillEffect {
  ...
  private multiActivationTypes: Array<number>;
  private additionalSkillsIds: Array<number>;
  private excludedSkillsIds: Array<number>;
  ...
  private fromTypeToText(type: number) {
    switch (type) {
      case 1:
