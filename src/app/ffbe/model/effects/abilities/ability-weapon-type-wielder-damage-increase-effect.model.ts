...
export class AbilityWeaponTypeWielderDamageIncreaseEffect extends SkillEffect {
  ...
  constructor(protected targetNumber: TargetNumberEnum,
    ...
    if (!Array.isArray(parameters) || parameters.length < 6 || parameters[3] !== 1 || parameters[5] !== 1
  ...
  protected wordEffectImpl(skill: Skill) {
    const categorie = FFBE_CATEGORIES_OBJETS.find(categorie => categorie.gumiId === this.weaponType);
