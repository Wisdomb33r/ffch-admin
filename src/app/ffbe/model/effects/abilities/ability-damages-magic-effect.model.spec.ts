...
import {AbilityDamagesMagicEffect} from './ability-damages-magic-effect.model';
...
describe('AbilityDamagesMagicEffect', () => {
  ...
  it('should parse magic neutral damages', () => {
    ...
    // WHEN
    const s = new AbilityDamagesMagicEffect(effect[0], effect[1], effect[2], effect[3]).wordEffect(fakeSkill);
    // THEN
