  ...
  `{
   ...
   "512175": {
    ...
    "703730": {
        ...
        "effects": [
            "Physical damage (1.8x, ATK) to all enemies",
            "Gain Berserker Serum+1 (503770), Blockade Serum+1 (503780) and Resist Down+1 (503790) for one turn"
        ],
        "effects_raw": [[2, 1, 1, [0,  0,  0,  0,  0,  0,  180,  0]], [0, 3, 100, [[2,  2,  2], [503770,  503780,  503790], 99999, 2, 1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "703740": {
        ...
        "effects": [
            "Physical damage (1.8x, ATK) to all enemies",
            "Gain Berserker Serum+2 (503690), Blockade Serum+2 (503700) and Resist Down+2 (503710) for one turn"
        ],
        "effects_raw": [[2, 1, 1, [0,  0,  0,  0,  0,  0,  180,  0]], [0, 3, 100, [[2,  2,  2], [503690,  503700,  503710], 99999, 2, 1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "503770": {
        ...
        "attack_type": "None",
        "element_inflict": null,
        "effects": ["Increase ATK and MAG by 100% for one turn to all allies"],
        "effects_raw": [[2, 2, 3, [100,  0,  100,  0,  1,  1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "503780": {
        ...
        "attack_type": "None",
        "element_inflict": null,
        "effects": ["Increase DEF and SPR by 100% for one turn to all allies"],
        "effects_raw": [[2, 2, 3, [0,  100,  0,  100,  1,  1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "503790": {
    ...
    "503690": {
        ...
        "element_inflict": null,
        "effects": [
            "Increase ATK and MAG by 100% for one turn to all allies",
            "Gain Berserker Serum+2 (503800), Blockade Serum+2 (503810) and Resist Down+2 (503820) for one turn"
        ],
        "effects_raw": [[2, 2, 3, [100,  0,  100,  0,  1,  1]], [0, 3, 100, [[2,  2,  2], [503800,  503810,  503820], 99999, 2, 1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "503700": {
        ...
        "effects_raw": [[2, 2, 3, [0,  100,  0,  100,  1,  1]], [0, 3, 100, [[2,  2,  2], [503800,  503810,  503820], 99999, 2, 1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "503710": {
        ...
        "element_inflict": null,
        "effects": [
            "Reduce resistance to all elements by 50% for one turn to all enemies",
            "Gain Berserker Serum+2 (503800), Blockade Serum+2 (503810) and Resist Down+2 (503820) for one turn"
        ],
        "effects_raw": [[2, 1, 33, [-50,  -50,  -50,  -50,  -50,  -50,  -50,  -50,  1,  1]], [0, 3, 100, [[2,  2,  2], [503800,  503810,  503820], 99999, 2, 1]]],
        "requirements": null,
        "unit_restriction": null
    },
    "236574": {
        ...
        "attack_type": "Physical",
        "element_inflict": null,
        "effects": ["Randomly use:\\n50%: Destructive Blade - Glacial Fissure (512781)\\n50%: Destructive Blade - Glacial Fissure (512782)"],
        "effects_raw": [[2, 1, 29, [[512781,  50], [512782,  50], 0, 0, 0, 0, 0]]],
        "requirements": null,
        "unit_restriction": null
    },
    "236575": {
        ...
        "attack_type": "Physical",
        "element_inflict": null,
        "effects": ["Randomly use:\\n40%: Destructive Blade - Glacial Fissure+1 (512783)\\n60%: Destructive Blade - Glacial Fissure+1 (512784)"],
        "effects_raw": [[2, 1, 29, [[512783,  40], [512784,  60], 0, 0, 0, 0, 0]]],
        "requirements": null,
        "unit_restriction": null
    },
    "512781": {
        ...
        "cost": {},
        "attack_count": [8, 1],
        "attack_damage": [[10,  10,  10,  10,  10,  10,  10,  30], [100]],
        "attack_frames": [[70,  76,  82,  88,  94,  100,  106,  112], [70]],
        "effect_frames": [[40,  40,  40,  40], [40]],
        "move_type": 4,
        "motion_type": 2,
        "effect_type": "Default",
        "attack_type": "Physical",
        "element_inflict": null,
        "effects": [
            "Physical damage (34x, ATK) to all enemies",
            "Reduce resistance to Ice by 120% for 3 turns to all enemies"
        ],
        "effects_raw": [[2, 1, 1, [0,  0,  0,  0,  0,  0,  3400,  0]], [2, 1, 33, [0,  -120,  0,  0,  0,  0,  0,  0,  1,  3]]],
        "requirements": null,
        "unit_restriction": null
    },
    "512782": {
        ...
        "element_inflict": null,
        "effects": [
            "Physical damage (51x, ATK) to all enemies",
            "Reduce resistance to Ice by 120% for 3 turns to all enemies"
        ],
        "effects_raw": [[2, 1, 43, [0,  0,  3400,  0]], [2, 1, 33, [0,  -120,  0,  0,  0,  0,  0,  0,  1,  3]]],
        "requirements": null,
        "unit_restriction": null
    },
    "512783": {
        ...
        "element_inflict": null,
        "effects": [
            "Physical damage (39x, ATK) to all enemies",
            "Reduce resistance to Ice by 120% for 3 turns to all enemies"
        ],
        "effects_raw": [[2, 1, 1, [0,  0,  0,  0,  0,  0,  3900,  0]], [2, 1, 33, [0,  -120,  0,  0,  0,  0,  0,  0,  1,  3]]],
        "requirements": null,
        "unit_restriction": null
    },
    "512784": {
        ...
        "element_inflict": null,
        "effects": [
            "Physical damage (58.5x, ATK) to all enemies",
            "Reduce resistance to Ice by 120% for 3 turns to all enemies"
        ],
        "effects_raw": [[2, 1, 43, [0,  0,  3900,  0]], [2, 1, 33, [0,  -120,  0,  0,  0,  0,  0,  0,  1,  3]]],
        "requirements": null,
        "unit_restriction": null
    }
  }`;
