...
export class AbilitySingleAllyCoversParser extends EffectParser {
  public parse(effect: Array<any>, skill: Skill): string {
    ...
    const damageType = 'physiques et magiques';
    ...
    return `${chances}% de chance pour ${defender} de protéger ${covered} des dégâts ${damageType} avec mitigation de ${mitigation} des dégâts reçus${turns}`;
  }
}
