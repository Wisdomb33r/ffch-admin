...
import {PassiveLbPerTurnParser} from '../../model/effects/passives/limitburst/passive-lb-per-turn.parser';
import {PassiveEvasionPhysicalParser} from './passives/passive-evasion-physical.parser';
import {PassiveLbDamageIncreaseParser} from '../../model/effects/passives/limitburst/passive-lb-damage-increase.parser';
import {PassiveTargetChanceChangesParser} from './passives/passive-target-chance-changes.parser';
import {PassiveLbSpeedIncreaseParser} from '../../model/effects/passives/limitburst/passive-lb-speed-increase.parser';
...
import {PassiveLbUpgradeParser} from '../../model/effects/passives/limitburst/passive-lb-upgrade.parser';
import {PassiveLbUpgradeHpThresholdParser} from '../../model/effects/passives/limitburst/passive-lb-upgrade-hp-threshold.parser';
