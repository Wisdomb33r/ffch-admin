...
describe('DataMiningClientService', () => {
  ...
  it('should delegate to HttpClient for accessing skills names', inject([DataMiningClientService], (service: DataMiningClientService) => {
    // WHEN
    service.getSkillsNames$();
    // THEN
    expect(httpClient.get).toHaveBeenCalled();
  }));
  ...
  it('should delegate to HttpClient for accessing field effects', inject([DataMiningClientService], (service: DataMiningClientService) => {
    // WHEN
    service.getFieldEffects$();
    // THEN
    expect(httpClient.get).toHaveBeenCalled();
  }));
});
